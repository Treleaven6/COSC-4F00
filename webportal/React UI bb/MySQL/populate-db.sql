...
INSERT INTO Account (id, permission, firstname, lastname, username, email, password, salt)
VALUES ('000000', 1, 'Professor', 'Professorson', 'test', 'anemail@brocku.ca', 'test', 'nightschool');

INSERT INTO Subject (code, name, description)
VALUES ('MATH2P98', 'Applied Statistics', 'We do math.');

INSERT INTO Subject (code, name, description)
VALUES ('COSC4F00', 'Project Engineering', 'We plan stuff.');
...
INSERT INTO Course (code, instructor, year, semester)
VALUES ('COSC4F00', '000000', 2019, 'winter');
...
INSERT INTO Assignment (course, name)
VALUES (4, 'Test Assignment');

INSERT INTO Submission (id, course, assignment, submit_time)
VALUES ('999888', 1, 1, CURRENT_TIMESTAMP(0));

INSERT INTO Submission (id, course, assignment, submit_time)
VALUES ('987987', 1, 2, CURRENT_TIMESTAMP(0));
